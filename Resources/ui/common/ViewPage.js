function ViewPage(data, rect, path) {
    ...
    self.inicio = function() {
        var ptHeight = Ti.Platform.displayCaps.platformHeight, ptWidth = Ti.Platform.displayCaps.platformWidth;
        var px = 0;
        var py = 0;
        var offset = {
            x : 0,
        ...
        // //TODO: Adiciona o Icone na página se existir.
