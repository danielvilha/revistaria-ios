...
@interface RevistariaiOSObject : KrollCoverageObject {
#else
@interface RevistariaiOSObject : KrollObject {
#endif
@private
...
extern NSString * RevistariaiOS$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	RevistariaiOSObject *_revistariaios;
    KrollObject* console;
	BOOL shutdown;
