...
//Rare exceptions to indicate a bug in the _revistariaios code (Eg, function that a subclass should have implemented)
...
/**
 The base class for RevistariaiOS proxies.
 */
