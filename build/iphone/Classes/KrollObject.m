...
//@interface RevistariaiOSObject : NSObject
//@end

@interface RevistariaiOSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RevistariaiOSObject class]])
		{
			for (NSString *key in [[(RevistariaiOSObject*)o modules] allKeys])
			{
