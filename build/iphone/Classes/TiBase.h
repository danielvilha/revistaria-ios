...
// in simulator we redefine to format for RevistariaiOS Developer console
...
{\
	NSString * exceptionName = [@"org.revistariaios." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.revistariaios";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRevistariaiOSNativeItemNone = -1, 
	UIRevistariaiOSNativeItemSpinner = -2,
	UIRevistariaiOSNativeItemProgressBar = -3,
	
	UIRevistariaiOSNativeItemSlider = -4,
	UIRevistariaiOSNativeItemSwitch = -5,
	UIRevistariaiOSNativeItemMultiButton = -6,
	UIRevistariaiOSNativeItemSegmented = -7,
	
	UIRevistariaiOSNativeItemTextView = -8,
	UIRevistariaiOSNativeItemTextField = -9,
	UIRevistariaiOSNativeItemSearchBar = -10,
	
	UIRevistariaiOSNativeItemPicker = -11,
	UIRevistariaiOSNativeItemDatePicker = -12,
	
	UIRevistariaiOSNativeItemInfoLight = -13,
	UIRevistariaiOSNativeItemInfoDark = -14,
	
	UIRevistariaiOSNativeItemDisclosure = -15,
	
	UIRevistariaiOSNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RevistariaiOS instances of
