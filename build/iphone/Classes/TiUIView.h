...
/**
 Base class for all RevistariaiOS views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RevistariaiOS view hierarchy (such as wrapped iOS UIViews) was touched.
